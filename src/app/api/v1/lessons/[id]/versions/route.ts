...
export async function POST(request: Request, { params }: { params: Promise<{ id: string }> }) {
  ...
  const version = await createDraft(id, body.contentPath || lesson.contentPath, body.changelog)
  if (body.action === "submit-for-review") await submitForReview(version.id)
